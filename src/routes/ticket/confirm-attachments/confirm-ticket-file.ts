...
import { confirmTicketFileValidation } from "./confirm-ticket-file.validation";

const router = express.Router();

router.post(
  "/v1/ticket/attachments/confirm",
  responseHandler,
  isAuthenticated,
  confirmTicketFileValidation,
  validateRequest,
...
export { router as confirmTicketFileV1Router };
